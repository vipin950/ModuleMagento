...
namespace Operations\Applyjob\ViewModel;

use Operations\Applyjob\Helper\Data;
     ...
     */
      ...
      */
       ...
       */
       ...
       {
         return $this->helper->getPostValue('experiance');
       }
       ...
       */
       ...
       {
          return $this->helper->getPostValue('jobposts');
       }
}