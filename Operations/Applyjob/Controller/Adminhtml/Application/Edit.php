 ...
 */
class Edit extends \Operations\Applyjob\Controller\Adminhtml\Application implements HttpGetActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('candidate_job', $model);
