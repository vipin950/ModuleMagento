...
use Nethues\Job\Model\View;
use Nethues\Job\Model\ViewFactory;
use Magento\Framework\App\Request\DataPersistorInterface;
use Magento\Framework\Exception\LocalizedException;
use Magento\Framework\Registry;

class Save extends  \Nethues\Job\Controller\Adminhtml\Application implements HttpPostActionInterface
{
      /**
    ...
    private function processBlockReturn($model, $data, $resultRedirect)
    {
        ...
        if ($redirect ==='continue') {
            $resultRedirect->setPath('job/candidate/edit', ['id' => $model->getId()]);
        } elseif ($redirect === 'close') {
            $resultRedirect->setPath('job/candidate/');
            ...
            $this->dataPersistor->set('candidate_job', $data);
            $resultRedirect->setPath('job/candidate/edit', ['id' => $id]);
        }
