 ...
 */
namespace Nethues\Rentocar\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const CMS_URL_PATH_EDIT = 'car/acation/edit';
    const CMS_URL_PATH_DELETE = 'car/acation/delete';
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                // echo '</pre>';
                // exit;
                if (isset($item['id_car'])) {
                    $item[$name]['edit'] = [
                        'href' => $this->urlBuilder->getUrl($this->editUrl, ['id_car' => $item['id_car']]),
                        'label' => __('Edit'),
                    ];
                    $title = $this->getEscaper()->escapeHtml($item['car_name']);
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::CMS_URL_PATH_DELETE, ['id_car' => $item['id_car']]),
                        'label' => __('Delete'),
                        'confirm' => [
